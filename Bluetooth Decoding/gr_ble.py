...
# Author: Jan Wagner
# Generated: Wed Jan 30 13:19:51 2019
##################################################
...
class gr_ble(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/spencer/Documents/BLEtest2.txt', True)
        ...
        self.connect((self.unpacked_to_packed, 0), (self.blocks_file_sink_0, 0))
